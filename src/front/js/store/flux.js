...
const getState = ({ getStore, getActions, setStore }) => {
  return {
    store: {
      ...
      datosUsuario: {},
      ciudades: [
        { ciudad: "A Coruña", posicion: [43.37012643, -8.39114853] },
        ...
        { ciudad: "Las Palmas", posicion: [28.099378545, -15.413368411] },
        ...
        { ciudad: "San Sebastian", posicion: [43.31717158, -1.98191785] },
